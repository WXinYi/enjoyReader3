...
//        [saveKeys addObject:@(ZSSRichTextEditorToolbarStrikeThrough)];
//        [saveKeys addObject:@(ZSSRichTextEditorToolbarH1)];
//        [saveKeys addObject:@(ZSSRichTextEditorToolbarH2)];
//        [saveKeys addObject:@(ZSSRichTextEditorToolbarHorizontalRule)];
...
- (UIBarButtonItem*)htmlBarButtonItem
{
    if (!_htmlBarButtonItem) {
        ...
        ZSSBarButtonItem *htmlButton = [self barButtonItemWithTag:kWPEditorViewControllerElementiPhoneShowSourceBarButton
                                                  ...
                                                  accessibilityLabel:accessibilityLabel];//showHTMLSource:  hideKeyboard
