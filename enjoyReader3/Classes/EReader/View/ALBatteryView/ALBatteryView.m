...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // add it to the view
        UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"电池"]];
...
//        [batteryFill setFrame:CGRectMake(kBatteryFillX, kBatteryFillY, 20, kBatteryFillHeight)];
        [batteryFill setFrame:CGRectMake(kBatteryFillX+0.5, kBatteryFillY+1, 18, kBatteryFillHeight-2)];

        [batteryFill setBackgroundColor:[UIColor grayColor]];
